            ...
            <form action="{{ route('stock.update',$stock->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-8">
                        <input class="form-control form-control-lg @error('nombre_stock') is-invalid @enderror"
                            type="text"
                            name="nombre_stock" id="nombre_stock" value="{{ old('nombre_stock') ?? $stock->nombre_stock }}">
                        @error('nombre_stock')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-8">
                        <input class="form-control form-control-lg @error('fecha_creacion') is-invalid @enderror"
                            type="date"
                            name="fecha_creacion" id="fecha_creacion" value="{{ old('fecha_creacion') ?? $stock->fecha_creacion}}">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        ...
                        name="descripcion" 
                        id="descripcion" rows="4"> {{ old('descripcion') ?? $stock->descripcion }} </textarea>
                        @error('descripcion')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-8">
                        ...
                        type="number" name="stock" id="stock" value="{{ old('stock') ?? $stock->stock }}">
                        @error('stock')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-8">
                        ...
                        type="file" name="img" id="img" accept="image/*" value="{{ old('img') ?? $stock->img}}">
                        @error('img')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
